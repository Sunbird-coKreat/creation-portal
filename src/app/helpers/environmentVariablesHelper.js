...
let envVariables = {
  ...
  PORTAL_PORT: env.sunbird_port || 3001,
  ...
  SUNBIRD_LEARNER_URL: env.sunbird_learner_url || 'https://staging.ntp.net.in/api/',
  ...
  sunbird_cloud_storage_key: env.sunbird_cloud_storage_key || "AKIASM3PAPX64TA2HUOE",
  sunbird_cloud_storage_secret: env.sunbird_cloud_storage_secret  || "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",
  sunbird_cloud_report_container: env.sunbird_cloud_report_container  || 'reports',
  sunbird_cloud_storage_region: env.sunbird_cloud_storage_region || "ap-south-1",
  ...
  PORTAL_EXT_PLUGIN_URL: process.env.sunbird_ext_plugin_url || 'http://player_player:3001/plugin/',
  ...
  OPENSABER_SERVICE_URL: env.opensaber_service_url || 'https://dock.sunbirded.org/api/',
  DOCK_PROGRAM_SERVICE_URL: env.dock_program_service_url || 'https://dock.sunbirded.org/api/',
  ...
  // Dock Knolg Service Configuration
