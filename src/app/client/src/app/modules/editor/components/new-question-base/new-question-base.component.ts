...
@Component({
  selector: 'app-new-question-base',
  templateUrl: './new-question-base.component.html',
  styleUrls: ['./new-question-base.component.scss']
})
export class NewQuestionBaseComponent implements OnInit {
  ...
  //  const questionSetId = _.get(this.activatedRoute, 'snapshot.params.questionId');
   ...
   if(!_.isUndefined(this.questionId)) {
      // make read question api call and get question metadata
      // this.editorState = { question: '<p>color of apple is</p>', answer: '<p>red</p>', solutions: '', options: [] };
      ...
      .subscribe((res)=> {
        ...
        if(res.result) {
          ...
          // this.editorState.solutions = '<p>hello</p>';
  ...
  // Can be deleted after testing once if requried or not
  // optionMedia(media) {
  //   if (media) {
  //     const value = _.find(this.mediaArr, ob => {
  //       return ob.id === media.id;
  ...
  //       this.mediaArr.push(media);
  //     }
  //     console.log("this.mediaArr new comp", this.mediaArr);
  //   }
  // }
