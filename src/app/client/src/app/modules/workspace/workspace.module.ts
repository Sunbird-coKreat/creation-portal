...
import {
  WorkspaceComponent,
  ReviewSubmissionsComponent, UploadedComponent,
  CollectionEditorComponent, ContentEditorComponent, GenericEditorComponent,
  WorkspacesidebarComponent, UpForReviewComponent, UpforReviewFilterComponent, UpdateBatchComponent,
...
@NgModule({
  ...
  declarations: [WorkspaceComponent, WorkspacesidebarComponent,
   ReviewSubmissionsComponent, UploadedComponent, CollectionEditorComponent,
    ContentEditorComponent, GenericEditorComponent, UpForReviewComponent, UpforReviewFilterComponent, UpForReviewComponent, UpforReviewFilterComponent,
