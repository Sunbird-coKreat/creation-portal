...
export class BulkUploadComponent implements OnInit {
  ...
  public levels = [];
  public sampleMetadataCsvUrl: string = (<HTMLInputElement>document.getElementById('portalCloudStorageUrl'))
  ? (<HTMLInputElement>document.getElementById('portalCloudStorageUrl')).value.split(',')  + 'bulk-content-upload-format.csv' : undefined;
