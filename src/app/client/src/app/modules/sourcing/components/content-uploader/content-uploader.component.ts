...
//   }
  ...
  createQuestionSet() {
      ...
      if (isTimeValid) {
        ...
        const primaryCategoryInteractiveVideo = (<HTMLInputElement>document.getElementById('interactiveVideoCategory'))
            ...
            data: {
              request: {
                questionset: {
                  ...
                  'primaryCategory': primaryCategoryInteractiveVideo,
                  'creator': creator,
                  'author': creator,
