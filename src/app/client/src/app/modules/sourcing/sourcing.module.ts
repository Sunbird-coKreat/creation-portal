...
import { QuestionListComponent,
  QuestionCreationComponent, McqCreationComponent, McqTemplateSelectionComponent,
  CkeditorToolComponent, QuestionPreviewComponent, BulkUploadComponent, BulkApprovalComponent } from './components';
import { SuiTabsModule, SuiModule } from '@project-sunbird/ng2-semantic-ui';
...
@NgModule({
  declarations: [QuestionListComponent, QuestionCreationComponent,
    ...
    QuestionCreationHeaderComponent, RecursiveTreeComponent,
    ...
    QuestionCreationComponent, McqCreationComponent, CkeditorToolComponent ,
    McqTemplateSelectionComponent, QuestionPreviewComponent, QuestionCreationHeaderComponent, RecursiveTreeComponent, ContentUploaderComponent,
